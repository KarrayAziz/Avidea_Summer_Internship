...
class CustomVRICExtractor:
    def __init__(self, checkpoint_name="net_19.pth"):
        ...
        print(f"Initializing Custom Vehicle Re-ID Model using {checkpoint_name}...")
        
        # 1. Load training configuration options
        ...
        # 2. Load checkpoint to inspect architecture
        ...
        # Check for both 'ibn' (lowercase) and 'IN' (Instance Normalization)
