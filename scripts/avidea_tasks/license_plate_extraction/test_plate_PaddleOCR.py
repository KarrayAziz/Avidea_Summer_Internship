...
from scripts.plate_extractor_PaddleOCR import TunisianPlateExtractor
...
def run_multi_image_test():
    ...
    parser.add_argument(
        "--dir", "-d",
        type=str,
        default="/home/aziz/Pictures/Internship_Images/detetction des faces/back/testing",
    ...
    parser.add_argument(
        "--save_dir", "-s",
        type=str,
        default="output_crops_PaddleOCR",
